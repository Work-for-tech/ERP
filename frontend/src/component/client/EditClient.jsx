...
export const EditClient = () => {
    ...
    var { register, handleSubmit, formState: { errors } } = useForm({
        defaultValues: async () => {
            const client = await axios.get("http://localhost:9999/inverntoryManagment/api/v1/public/client/client/" + id)
            return {
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="form-group mandatory">
                                                <label htmlFor="panNumber" class="form-label">PAN Number</label>
                                                <input
                                                    type="text"
                                                    ...
                                                    data-parsley-required="true"
                                                    {...register("panNumber", validation?.panNumber)}
                                                />
                                                <span className='text-danger font-weight-bold'>{errors?.panNumber?.message}</span>
                                            </div>
                                            <div className="form-group mandatory">
