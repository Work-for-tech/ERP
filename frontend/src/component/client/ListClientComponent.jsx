...

                                                        {
                                                            data.data.data?.map(client => {
                                                                return (
                                                                    <>
                                                                        <tr>
                                                                            <td className="text-bold-500">{client.name}</td>
                                                                            <td>{client.email}</td>
                                                                            <td className="text-bold-500">{client.phoneNumber}</td>
                                                                            ...
                                                                            <td>
                                                                                <button
                                                                                    ...
                                                                                    data-bs-target={`#primary${client._id}`}
                                                                                >
                                                                                    <i class="bi bi-card-text text-primary"></i>
                                                                                </button>
                                                                                <Link to={`editclient/${client._id}`} className='btn btn-sm'>
                                                                                ...
                                                                                <div className="modal-content">
                                                                                    ...
                                                                                    <div className="modal-body">
                                                                                        <tr className='d-flex flex-column'>
                                                                                            <td>
                                                                                                <h6>Second email</h6>
                                                                                                <p>{client?.email2 ? client?.email2 : "No second email"}</p>
                                                                                            </td>
                                                                                            <td>
                                                                                                <h6>Second contect number</h6>
                                                                                                <p>{client?.phoneNumber2 ? client?.phoneNumber2 : "No second phone number"}</p>
                                                                                            </td>
                                                                                            <td>
                                                                                                <h6>Address</h6>
                                                                                                <p>{client?.address}</p>
